...
class ProfileContextLayerTests(unittest.TestCase):
    ...
    def test_profile_clarification_policy_localizes_questions_to_requested_locale(self) -> None:
        policy = DefaultProfileClarificationPolicy()
        ...
        self.assertEqual(
            decision.question_text,
            "Сделать стиль максимально носибельным, сбалансированным или более выразительным?",
        )
        self.assertEqual(decision.question_key, "style_wearability")
